...
/******/ 		return __webpack_require__.p + "" + chunkId + ".main." + {"1":"fa3c20238407bc9f7536","2":"b080358ac72a8b1ddc18","3":"4f0eb6b77f99231b8ca7","4":"b291b827c9cef0908426","5":"7c0ec5fcfe5220ec5a75","6":"35ad35dcfd94192fce70","7":"7571b6fe7b1b65da255d","8":"21a53e86a417dc4c98d6","9":"1e1028b8901f7bf5976b","10":"47f7dbd3aaff91bce00e","11":"59d76f4ea06fdae98edf","12":"3e5112ac494e4369de7b","13":"417c9fdc6c2c8b144289","14":"35beb5c33be6c51f1020","15":"57d1d8b81b72120c10e5","16":"b77388f0eafea4b78ab2","17":"1e96ce907c902115fccb","18":"369c6a98450c7c6e4f11","19":"935583e6d8cde6be2b0b","20":"29753ceb94a91dffcac7","21":"87d59c790fac84bf25fb","22":"d51673b8a305e5220ba4","23":"4e199ea4dafa0bb16b90","24":"410c46336c28eb0d7f8a","25":"ec7dc2880107d1f4b166","26":"723b470c175682a6a0d8","27":"694f33101f471aeea960","28":"476bde53d48d69079966","29":"12c9f61c367710b3298d","30":"5a72305f367032ca2c0b","31":"c8786befd47052e9968d","32":"d678f99ca3ad6bdea5da","33":"e0ca5c4e83c000e3ae74","34":"9006e2df1240eb0191b5","35":"7c54c35b9e4af1f170a2","36":"7e71237cc7617b0ed636","37":"8d749a87cbc846fc9bdb"}[chunkId] + ".js"
/******/ 	}
/******/
...
var map = {
	"./thumbnail/animal_1.jpg": [
		13,
		1
	],
	"./thumbnail/animal_10.jpg": [
		14,
		2
	],
	"./thumbnail/animal_11.jpg": [
		15,
		3
	],
	"./thumbnail/animal_12.jpg": [
		16,
		4
	],
	"./thumbnail/animal_13.jpg": [
		17,
		5
	],
	"./thumbnail/animal_14.jpg": [
		18,
		6
	],
	"./thumbnail/animal_15.jpg": [
		19,
		7
	],
	"./thumbnail/animal_16.jpg": [
		20,
		8
	],
	"./thumbnail/animal_17.jpg": [
		21,
		9
	],
	"./thumbnail/animal_18.jpg": [
		22,
		10
	],
	"./thumbnail/animal_19.jpg": [
		23,
		11
	],
	"./thumbnail/animal_2.jpg": [
		24,
		12
	],
	"./thumbnail/animal_3.jpg": [
		25,
		13
	],
	"./thumbnail/animal_4.jpg": [
		26,
		14
	],
	"./thumbnail/animal_5.jpg": [
		27,
		15
	],
	"./thumbnail/animal_6.jpg": [
		28,
		16
	],
	"./thumbnail/animal_7.jpg": [
		29,
		17
	],
	"./thumbnail/animal_8.jpg": [
		30,
		18
	],
	"./thumbnail/animal_9.jpg": [
		31,
		19
	],
	"./thumbnail/banner_1.jpg": [
		32,
		20
	],
	"./thumbnail/banner_2.jpg": [
		33,
		21
	],
	"./thumbnail_original/ENFJ_Wonderwoman_1.jpg": [
		34,
		22
	],
	"./thumbnail_original/ENFP_HarleyQuinn_1.jpg": [
		35,
		23
	],
	"./thumbnail_original/ENTJ_aquaman_1.jpg": [
		36,
		24
	],
	"./thumbnail_original/ENTP_joker_1.jpg": [
		37,
		25
	],
	"./thumbnail_original/ESFJ_starfire_1.jpg": [
		38,
		26
	],
	"./thumbnail_original/ESFP_GreenLantern_1.jpg": [
		39,
		27
	],
	"./thumbnail_original/ESTJ_Hawkman_1.jpg": [
		40,
		28
	],
	"./thumbnail_original/ESTP_catwoman_1.jpg": [
		41,
		29
	],
	"./thumbnail_original/INFJ_PoisonEve_1.jpg": [
		42,
		30
	],
	"./thumbnail_original/INFP_Flash_1.jpg": [
		43,
		31
	],
	"./thumbnail_original/INTJ_batman_1.jpg": [
		44,
		32
	],
	"./thumbnail_original/INTP_Riddler_1.jpg": [
		45,
		33
	],
	"./thumbnail_original/ISFJ_Superman_1.jpg": [
		46,
		34
	],
	"./thumbnail_original/ISFP_Zatana_1.jpg": [
		47,
		35
	],
	"./thumbnail_original/ISTJ_John-Stewart_1.jpg": [
		48,
		36
	],
	"./thumbnail_original/ISTP_JohnConstantine_1.jpg": [
		49,
		37
	]
};
...
function sendType(personaltyType) {
  return {
    type: "CHANGE_TYPE",
    personaltyType: personaltyType
  };
}
function sendTestresult(testresult) {
  return {
...
function changeType(personality, action) {
  switch (action.type) {
    case "CHANGE_TYPE":
      var newPersonality = action.personaltyType;
...
function changeTestresult(testresult, action) {
  switch (action.type) {
    case "CHANGE_TESTRESULT":
      var newTestresult = action.testresult;
...
var personalities = __webpack_require__(2);
...
var personalitycard_Personalitycard = /*#__PURE__*/function (_HTMLElement) {
  ...
  function Personalitycard(type) {
    ...
    _this.store = store_store;
    _this.route = {
      path: "personalitytypes/personality_".concat(_this.type.id)
    };
    return _this;
  }
  ...
  personalitycard_createClass(Personalitycard, [{
    ...
    value: function handleClick() {
      /* richtung card */
      localStorage.setItem("personality", JSON.stringify({
        type: this.type
      }));
      this.store.dispatch(loadRoute({
        path: this.route.path
      }));
      this.store.dispatch(sendType({
        type: this.type
      }));
    }
  }, {
    ...
    value: function render() {
      ...
      __webpack_require__(0)("./thumbnail".concat(path)).then(function (image) {
...
var personalitytype_Personalitytypes = /*#__PURE__*/function (_HTMLElement) {
  personalitytype_inherits(Personalitytypes, _HTMLElement);

  var _super = personalitytype_createSuper(Personalitytypes);

  function Personalitytypes() {
    var _this;

    personalitytype_classCallCheck(this, Personalitytypes);
  ...
  personalitytype_createClass(Personalitytypes, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      this.render();
...
customElements.define("personalites-component", personalitytype_Personalitytypes);
...
var progress_Progress = /*#__PURE__*/function (_HTMLElement) {
  ...
  progress_createClass(Progress, [{
    ...
    value: function shouldUpdate() {
      ...
      if (this.store.previousState.progress.counter != this.store.state.progress.counter) {
        ...
        var progressing = setInterval(function () {
          _this2.startPosition += 1;

          _this2.render();

          if (_this2.startPosition >= _this2.endPosition) {
            clearInterval(progressing);
            if (_this2.startPosition >= 100) _this2.startPosition = 0;
          }
        }, 65);
      }
    }
    ...
    key: "render",
    value: function render() {
      this.innerHTML = "\n    <section id=\"test_header\">\n        <div id=\"progress_section\">\n            <div id=\"progress_number\">".concat(this.startPosition, "%\n            </div>\n            <div id=\"progress\">\n                <div id=\"progress_bar\" style=\"width:").concat(this.startPosition, "%\">\n                </div>\n            </div>\n        </div>\n    </section>");
    }
  }]);
  ...
  test_createClass(Test, [{
    ...
    value: function loadcontent(start, end) {
      ...
      if (start < questions_data.length) {
        ...
        var resultObj = this.Score.getResultObj;
        ...
        this.store.dispatch(sendTestresult({
          result: resultObj
        }));
      }
...
// EXTERNAL MODULE: ./src/css/contact.css
var contact = __webpack_require__(4);

// CONCATENATED MODULE: ./src/img/email.png
/* harmony default export */ var email = (__webpack_require__.p + "imgs/email60212200ba71d735f0f4c3e289bd76a3.png");
// CONCATENATED MODULE: ./src/img/place.png
/* harmony default export */ var place = (__webpack_require__.p + "imgs/placeec28755cfbc5d5a234e50bb1072778fb.png");
// CONCATENATED MODULE: ./src/img/exclamation_circle.png
/* harmony default export */ var exclamation_circle = (__webpack_require__.p + "imgs/exclamation_circle492b8c0e68cc399722df7335b512cac9.png");
// CONCATENATED MODULE: ./src/js/Components/Contact/contactvalidator.js
function contactvalidator_toConsumableArray(arr) { return contactvalidator_arrayWithoutHoles(arr) || contactvalidator_iterableToArray(arr) || contactvalidator_unsupportedIterableToArray(arr) || contactvalidator_nonIterableSpread(); }

function contactvalidator_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function contactvalidator_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return contactvalidator_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return contactvalidator_arrayLikeToArray(o, minLen); }

function contactvalidator_iterableToArray(iter) { if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter); }

function contactvalidator_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return contactvalidator_arrayLikeToArray(arr); }

function contactvalidator_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function contactvalidator_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function contactvalidator_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function contactvalidator_createClass(Constructor, protoProps, staticProps) { if (protoProps) contactvalidator_defineProperties(Constructor.prototype, protoProps); if (staticProps) contactvalidator_defineProperties(Constructor, staticProps); return Constructor; }

var ContactFormValidator = /*#__PURE__*/function () {
  function ContactFormValidator() {
    contactvalidator_classCallCheck(this, ContactFormValidator);

    this.form = document.getElementsByTagName("form");
    this.checkform(this.form[0]);
  }

  contactvalidator_createClass(ContactFormValidator, [{
    key: "checkform",
    value: function checkform(form) {
      ...
      contactvalidator_toConsumableArray(form).forEach(function (input) {
        if (input.name) {
          input.value.trim();
        }

        if (input.name === "firstname" && input.value === "") {
          _this.setErrorFor(input, "firstname can not be blank!");

          alltrue.push(false);
        } else if (input.name === "firstname" && input.value !== "") {
          _this.takeOffError(input);

          alltrue.push(true);
        }

        if (input.name === "lasttname" && input.value === "") {
          _this.setErrorFor(input, "lastname can not be blank!");
        ...
        if (input.name === "email" && input.value === "") {
          _this.setErrorFor(input, "email can not be blank!");

          alltrue.push(false);
        } else if (input.name === "email" && input.value !== "") {
          if (!_this.isEmail(input.value)) {
            _this.setErrorFor(input, "email is not valid");
        ...
        if (input.name === "comments" && input.value === "") {
          _this.setErrorFor(input, "comments can not be blank!");
    ...
    value: function setErrorFor(input, message) {
      ...
      var errorContainer = formcontrol.querySelector(".error_message");
      errorContainer.innerText = message;
      formcontrol.className = "contact_row contactform-error";
    }
  }, {
    key: "takeOffError",
    value: function takeOffError(input) {
      var formcontrol = input.parentElement.parentElement;
      var errorContainer = formcontrol.querySelector(".error_message");
...
// CONCATENATED MODULE: ./src/js/Components/Contact/contactform.js
function contactform_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { contactform_typeof = function _typeof(obj) { return typeof obj; }; } else { contactform_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return contactform_typeof(obj); }
...
function contactform_createSuper(Derived) { var hasNativeReflectConstruct = contactform_isNativeReflectConstruct(); return function () { var Super = contactform_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = contactform_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return contactform_possibleConstructorReturn(this, result); }; }
...
function contactform_wrapNativeSuper(Class) { var _cache = typeof Map === "function" ? new Map() : undefined; contactform_wrapNativeSuper = function _wrapNativeSuper(Class) { if (Class === null || !contactform_isNativeFunction(Class)) return Class; if (typeof Class !== "function") { throw new TypeError("Super expression must either be null or a function"); } if (typeof _cache !== "undefined") { if (_cache.has(Class)) return _cache.get(Class); _cache.set(Class, Wrapper); } function Wrapper() { return contactform_construct(Class, arguments, contactform_getPrototypeOf(this).constructor); } Wrapper.prototype = Object.create(Class.prototype, { constructor: { value: Wrapper, enumerable: false, writable: true, configurable: true } }); return contactform_setPrototypeOf(Wrapper, Class); }; return contactform_wrapNativeSuper(Class); }

function contactform_construct(Parent, args, Class) { if (contactform_isNativeReflectConstruct()) { contactform_construct = Reflect.construct; } else { contactform_construct = function _construct(Parent, args, Class) { var a = [null]; a.push.apply(a, args); var Constructor = Function.bind.apply(Parent, a); var instance = new Constructor(); if (Class) contactform_setPrototypeOf(instance, Class.prototype); return instance; }; } return contactform_construct.apply(null, arguments); }

function contactform_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }

function contactform_isNativeFunction(fn) { return Function.toString.call(fn).indexOf("[native code]") !== -1; }
...
var contactform_ContactForm = /*#__PURE__*/function (_HTMLElement) {
  contactform_inherits(ContactForm, _HTMLElement);

  var _super = contactform_createSuper(ContactForm);
  ...
  contactform_createClass(ContactForm, [{
    ...
    value: function handleSubmit(e) {
      e.preventDefault();
      var contactFormValidator = new ContactFormValidator();
    }
  }, {
    key: "connectedCallback",
    value: function connectedCallback() {
...
var contact_Contact = /*#__PURE__*/function (_HTMLElement) {
  ...
  function Contact() {
    ...
    _this.banner = new Banner(bannerconfig);
    _this.contactform = new contactform_ContactForm();
    return _this;
  }
  ...
  contact_createClass(Contact, [{
    ...
    value: function connectedCallback() {
      this.render();
      var test_wrapper = document.getElementById("contactcontainer_wrapper");
      test_wrapper.prepend(this.banner);
...
customElements.define("contact-component", contact_Contact);
...
// EXTERNAL MODULE: ./src/css/personality.css
var css_personality = __webpack_require__(5);

// CONCATENATED MODULE: ./src/js/Components/PersonalityTypes/personality.js
...
var personality_Personality = /*#__PURE__*/function (_HTMLElement) {
  ...
  function Personality() {
    ...
    _this = _super.call(this);
    _this.personality = JSON.parse(localStorage.getItem("personality"));
    _this.store = store_store;
    _this.subscriber = _this.load.bind(personality_assertThisInitialized(_this));

    _this.store.subscribe(_this.subscriber);

    _this.imgPath = "";

    _this.render(_this.personality.type);
  ...
  personality_createClass(Personality, [{
    ...
    value: function render(type) {
      ...
      __webpack_require__(0)("./thumbnail".concat(type.img)).then(function (image) {
        _this2.innerHTML = "\n      <section id=\"personality_banner_container\">\n        <div id=\"personality_banner\">\n          <div id=\"personality_banner_img\">\n            <img src=\"".concat(image["default"], "\" alt=\"").concat(type.title, "-image\"/>\n          </div>\n          <div id=\"personality_banner_desc\">\n            <h1>").concat(type.title, "</h1>\n            <h2>").concat(type.caption, "</h2>\n          </div>\n        </div>\n      </section>\n      <section id=\"personality_content\" class=\"type\">\n        <div class=\"container_left\">\n          <h1>PERSONALITY</h1>\n        </div>\n        <div class=\"container_right\">\n          <h1>").concat(type.title, "- ").concat(type.caption, "</h1>\n          <p>").concat(type.description, "</p>\n          <p><span class=\"personality-attributes\">STRENGTH: </span><span> ").concat(type.strength, "</span></p>\n          <p><span class=\"personality-attributes\">WEAKNESS: </span><span> ").concat(type.weakness, " </span></p>\n        </div>\n      </section>");
      });
    }
  }]);
...
customElements.define("personality-component", personality_Personality);
// EXTERNAL MODULE: ./src/css/testresult.css
var css_testresult = __webpack_require__(6);

// EXTERNAL MODULE: ./src/css/resultproperties.css
var resultproperties = __webpack_require__(7);

// CONCATENATED MODULE: ./src/js/Components/Personalitytest/resultproperties.js
function resultproperties_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { resultproperties_typeof = function _typeof(obj) { return typeof obj; }; } else { resultproperties_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return resultproperties_typeof(obj); }

function resultproperties_toConsumableArray(arr) { return resultproperties_arrayWithoutHoles(arr) || resultproperties_iterableToArray(arr) || resultproperties_unsupportedIterableToArray(arr) || resultproperties_nonIterableSpread(); }

function resultproperties_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function resultproperties_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return resultproperties_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return resultproperties_arrayLikeToArray(o, minLen); }

function resultproperties_iterableToArray(iter) { if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter); }

function resultproperties_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return resultproperties_arrayLikeToArray(arr); }

function resultproperties_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function resultproperties_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function resultproperties_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function resultproperties_createClass(Constructor, protoProps, staticProps) { if (protoProps) resultproperties_defineProperties(Constructor.prototype, protoProps); if (staticProps) resultproperties_defineProperties(Constructor, staticProps); return Constructor; }

function resultproperties_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) resultproperties_setPrototypeOf(subClass, superClass); }

function resultproperties_createSuper(Derived) { var hasNativeReflectConstruct = resultproperties_isNativeReflectConstruct(); return function () { var Super = resultproperties_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = resultproperties_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return resultproperties_possibleConstructorReturn(this, result); }; }

function resultproperties_possibleConstructorReturn(self, call) { if (call && (resultproperties_typeof(call) === "object" || typeof call === "function")) { return call; } return resultproperties_assertThisInitialized(self); }

function resultproperties_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function resultproperties_wrapNativeSuper(Class) { var _cache = typeof Map === "function" ? new Map() : undefined; resultproperties_wrapNativeSuper = function _wrapNativeSuper(Class) { if (Class === null || !resultproperties_isNativeFunction(Class)) return Class; if (typeof Class !== "function") { throw new TypeError("Super expression must either be null or a function"); } if (typeof _cache !== "undefined") { if (_cache.has(Class)) return _cache.get(Class); _cache.set(Class, Wrapper); } function Wrapper() { return resultproperties_construct(Class, arguments, resultproperties_getPrototypeOf(this).constructor); } Wrapper.prototype = Object.create(Class.prototype, { constructor: { value: Wrapper, enumerable: false, writable: true, configurable: true } }); return resultproperties_setPrototypeOf(Wrapper, Class); }; return resultproperties_wrapNativeSuper(Class); }

function resultproperties_construct(Parent, args, Class) { if (resultproperties_isNativeReflectConstruct()) { resultproperties_construct = Reflect.construct; } else { resultproperties_construct = function _construct(Parent, args, Class) { var a = [null]; a.push.apply(a, args); var Constructor = Function.bind.apply(Parent, a); var instance = new Constructor(); if (Class) resultproperties_setPrototypeOf(instance, Class.prototype); return instance; }; } return resultproperties_construct.apply(null, arguments); }

function resultproperties_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }

function resultproperties_isNativeFunction(fn) { return Function.toString.call(fn).indexOf("[native code]") !== -1; }

function resultproperties_setPrototypeOf(o, p) { resultproperties_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return resultproperties_setPrototypeOf(o, p); }

function resultproperties_getPrototypeOf(o) { resultproperties_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return resultproperties_getPrototypeOf(o); }


var Resultproperties = /*#__PURE__*/function (_HTMLElement) {
  resultproperties_inherits(Resultproperties, _HTMLElement);

  var _super = resultproperties_createSuper(Resultproperties);

  function Resultproperties(result) {
    var _this;

    resultproperties_classCallCheck(this, Resultproperties);
  ...
  resultproperties_createClass(Resultproperties, [{
    key: "handleClick",
    value: function handleClick(event) {
      var desc = event.target.nextElementSibling;
    ...
    value: function connectedCallback() {
      ...
      var desc_buttons = document.getElementsByClassName("desc_button");
      console.log(desc_buttons);

      resultproperties_toConsumableArray(desc_buttons).map(function (desc_btn) {
        desc_btn.addEventListener("click", _this2.handleClick.bind(_this2));
      });
    }
  }, {
    key: "render",
    value: function render(result) {
      for (var i = 0; i < result.body.length; i++) {
        var percentage_active_1 = "";
        var text_active_1 = "";
        var percentage_active_2 = "";
        var text_active_2 = "";
        ...
        this.innerHTML += "\n              <div class=\"result_row\">\n                <h1>".concat(result.body[i].caption, "</h1>\n                <p class=\"caption_desc\">").concat(result.body[i].caption_description, "</p>\n                <div class=\"resultbar_container\">\n                    <div class=\"percentage_text_left\">\n                        <p class=\"percentage_num_left ").concat(text_active_1, "\">").concat(result.body[i].percentage_1, "%</p>\n                        <p class=\"percentage_desc_left ").concat(text_active_1, "\">Extraverted</p>\n                    </div>\n                    <div class=\"percantage_container\">\n                        <div class=\"percentage_left ").concat(percentage_active_1, "\" style=\"width:").concat(result.body[i].percentage_1, "%;\">\n                        </div>\n                        <div class=\"percentage_right ").concat(percentage_active_2, "\" style=\"width:").concat(result.body[i].percentage_2, "%;\">\n                        </div>\n                    </div>\n                    <div class=\"percentage_text_right\">\n                        <p class=\"percentage_num_right ").concat(text_active_2, "\"> ").concat(result.body[i].percentage_2, "%</p>\n                        <p class=\"percentage_desc_right ").concat(text_active_2, "\">Introverted</p>\n                    </div>\n                </div>\n                <div id=\"id_").concat(i, "\" class=\"desc_button\">\n                </div>\n                <div class=\"desc\">\n                    <h1>").concat(result.body[i].header, "</h1>\n                    <p>").concat(result.body[i].description, "</p>\n                </div>\n              </div>");
      }
    }
  }]);

  return Resultproperties;
}( /*#__PURE__*/resultproperties_wrapNativeSuper(HTMLElement));
customElements.define("resultproperties-component", Resultproperties);
// CONCATENATED MODULE: ./src/js/Components/Personalitytest/testresults.js
function testresults_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { testresults_typeof = function _typeof(obj) { return typeof obj; }; } else { testresults_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return testresults_typeof(obj); }

function testresults_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function testresults_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function testresults_createClass(Constructor, protoProps, staticProps) { if (protoProps) testresults_defineProperties(Constructor.prototype, protoProps); if (staticProps) testresults_defineProperties(Constructor, staticProps); return Constructor; }

function testresults_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) testresults_setPrototypeOf(subClass, superClass); }

function testresults_createSuper(Derived) { var hasNativeReflectConstruct = testresults_isNativeReflectConstruct(); return function () { var Super = testresults_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = testresults_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return testresults_possibleConstructorReturn(this, result); }; }

function testresults_possibleConstructorReturn(self, call) { if (call && (testresults_typeof(call) === "object" || typeof call === "function")) { return call; } return testresults_assertThisInitialized(self); }

function testresults_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function testresults_wrapNativeSuper(Class) { var _cache = typeof Map === "function" ? new Map() : undefined; testresults_wrapNativeSuper = function _wrapNativeSuper(Class) { if (Class === null || !testresults_isNativeFunction(Class)) return Class; if (typeof Class !== "function") { throw new TypeError("Super expression must either be null or a function"); } if (typeof _cache !== "undefined") { if (_cache.has(Class)) return _cache.get(Class); _cache.set(Class, Wrapper); } function Wrapper() { return testresults_construct(Class, arguments, testresults_getPrototypeOf(this).constructor); } Wrapper.prototype = Object.create(Class.prototype, { constructor: { value: Wrapper, enumerable: false, writable: true, configurable: true } }); return testresults_setPrototypeOf(Wrapper, Class); }; return testresults_wrapNativeSuper(Class); }

function testresults_construct(Parent, args, Class) { if (testresults_isNativeReflectConstruct()) { testresults_construct = Reflect.construct; } else { testresults_construct = function _construct(Parent, args, Class) { var a = [null]; a.push.apply(a, args); var Constructor = Function.bind.apply(Parent, a); var instance = new Constructor(); if (Class) testresults_setPrototypeOf(instance, Class.prototype); return instance; }; } return testresults_construct.apply(null, arguments); }

function testresults_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }

function testresults_isNativeFunction(fn) { return Function.toString.call(fn).indexOf("[native code]") !== -1; }

function testresults_setPrototypeOf(o, p) { testresults_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return testresults_setPrototypeOf(o, p); }

function testresults_getPrototypeOf(o) { testresults_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return testresults_getPrototypeOf(o); }



 //shows the testresult

var testresults_Testresult = /*#__PURE__*/function (_HTMLElement) {
  testresults_inherits(Testresult, _HTMLElement);

  var _super = testresults_createSuper(Testresult);

  function Testresult() {
    var _this;

    testresults_classCallCheck(this, Testresult);

    _this = _super.call(this);
    var testresult = JSON.parse(localStorage.getItem("testresult"));
    _this.result = testresult.result;
    _this.store = store_store;
    _this.subscriber = _this.load.bind(testresults_assertThisInitialized(_this));
  ...
  testresults_createClass(Testresult, [{
    key: "connectedCallback",
    value: function connectedCallback() {
    ...
    key: "load",
    value: function load() {
      var result = this.store.state.testresult.result;
      this.render(result);
    }
  }, {
    key: "disconnectedCallback",
    ...
    value: function render(result) {
      ...
      __webpack_require__(0)("./thumbnail".concat(result.imgPath)).then(function (image) {
        _this2.innerHTML = "\n    <section id=\"result_banner_container\">\n      <div id=\"result_banner\">\n          <div id=\"result_banner_img\">\n           <img src=\"".concat(image["default"], "\" alt=\"").concat(result.label[0].Name, "-image\"/>\n          </div>\n          <div id=\"result_banner_desc\">\n              <h1>").concat(result.label[0].Name, "</h1>\n              <h2>").concat(result.label[1].Type, "</h2>\n          </div>\n      </div>\n    </section>\n    <section id=\"result_container\" >\n      <section id=\"result_header\" >\n          <h1>Congrats!</h1> \n          <h1>You are like ").concat(result.label[0].Name, "</h1>\n      </section>\n      <section id=\"result_wrapper\">\n          <div id=\"result_content\"></div>\n      </section>\n    </section>");
        var result_content = document.getElementById("result_content");
        var properties = new Resultproperties(result);
  ...
  return Testresult;
}( /*#__PURE__*/testresults_wrapNativeSuper(HTMLElement));
customElements.define("testresult-component", testresults_Testresult);
...
var routes_id = 0;
var pathI = "";
var routes_setDynamicRoutes = function setDynamicRoutes(id) {
  Object.values(personalities_personalities).map(function (personality) {
...
var routes = [{
  ...
  path: "home",
  flag: true,
  component: default_DefaultComponent
}, {
  title: "personalitytypes",
  path: "personalitytypes",
  flag: true,
  component: personalitytype_Personalitytypes
}, {
  title: "personalitytest",
  path: "personalitytest",
  flag: true,
  component: personalitytest_Personalitytest
}, {
  title: "contact",
  path: "contact",
  flag: true,
  ...
  flag: false,
  component: personality_Personality
}, {
  title: "testresult",
  path: "personalitytest/testresult",
  flag: false,
  component: testresults_Testresult
}];
  ...
  router_createClass(Router, [{
    ...
    value: function render(previousState, state) {
      if (previousState.route.path != state.route.path) {
        ...
        if (page.includes("_")) routes_setDynamicRoutes(page.slice(page.indexOf("_") + 1));
...
var css_nav = __webpack_require__(8);
...
var burger = __webpack_require__(9);
...
var navlinks_NavLinks = /*#__PURE__*/function () {
  ...
  navlinks_createClass(NavLinks, [{
    ...
    value: function render(nav) {
      ...
      Object.values(this.routes).map(function (route) {
        if (route.flag) {
          var link = new listItem_ListItem(route.title, _this.store, _this.btn);
...
var general = __webpack_require__(10);
